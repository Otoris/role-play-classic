--[[
All Credit for Animations goes to Kuropixel/Conna/Kuromiku
--]]
...
rpc.animation.stored.combineOverwatch = {
...
rpc.animation.stored.civilProtection = {
...
rpc.animation.stored.femaleHuman = {
	["crouch_grenade_aim_idle"] = ACT_COVER_LOW,
...
rpc.animation.stored.maleHuman = {
	["crouch_grenade_aim_idle"] = ACT_COVER_LOW,
	["crouch_grenade_aim_walk"] = ACT_WALK_CROUCH,
	["stand_grenade_aim_idle"] = ACT_IDLE,
...
function rpc.animation.GetModelClass(model, alwaysReal)
	local modelClass = rpc.animation.models[ string.lower(model) ];
...
function rpc.animation.AddCombineOverwatchModel(model)
	rpc.animation.AddModel("combineOverwatch", model);
end;

-- A function to add a Civil Protection model.
function rpc.animation.AddCivilProtectionModel(model)
	rpc.animation.AddModel("civilProtection", model);
end;

-- A function to add a female human model.
function rpc.animation.AddFemaleHumanModel(model)
	rpc.animation.AddModel("femaleHuman", model);
end;
...
function rpc.animation.GetWeaponHoldType(player, weapon)
	local class = string.lower( weapon:GetClass() );
	local weaponTable = weapons.GetStored(class);
	
	if ( rpc.animation.holdTypes[class] ) then
		return rpc.animation.holdTypes[class];
	elseif (weaponTable and weaponTable.HoldType) then
		if ( rpc.animation.convert[weaponTable.HoldType] ) then
			return rpc.animation.convert[weaponTable.HoldType];
		else
		...
		if (act != -1) then
			if ( rpc.animation.convert[act] ) then
				return rpc.animation.convert[act];
			else
				return "fist";
			end;
		else
...
function rpc.animation.GetTable(model)
	local lowerModel = string.lower(model);
	local class = rpc.animation.models[lowerModel];
	
	if ( class and rpc.animation.stored[class] ) then
		return rpc.animation.stored[class];
	elseif ( string.find(lowerModel, "female") ) then
		return rpc.animation.stored.femaleHuman;
	else
		return rpc.animation.stored.maleHuman;
	end;
end;

rpc.animation.AddCombineOverwatchModel("models/combine_soldier_prisonguard.mdl");
rpc.animation.AddCombineOverwatchModel("models/combine_super_soldier.mdl");
rpc.animation.AddCombineOverwatchModel("models/combine_soldier.mdl");

rpc.animation.AddCivilProtectionModel("models/police.mdl");

rpc.animation.AddFemaleHumanModel("models/humans/group01/female_01.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group01/female_02.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group01/female_03.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group01/female_04.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group01/female_06.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group01/female_07.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group02/female_01.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group02/female_02.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group02/female_03.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group02/female_04.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group02/female_06.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group02/female_07.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group03/female_01.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group03/female_02.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group03/female_03.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group03/female_04.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group03/female_06.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group03/female_07.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group03m/female_01.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group03m/female_02.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group03m/female_03.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group03m/female_04.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group03m/female_06.mdl");
rpc.animation.AddFemaleHumanModel("models/humans/group03m/female_07.mdl");
  
rpc.animation.AddMaleHumanModel("models/humans/group01/male_01.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group01/male_02.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group01/male_03.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group01/male_04.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group01/male_05.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group01/male_06.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group01/male_07.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group01/male_08.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group01/male_09.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group02/male_01.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group02/male_02.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group02/male_03.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group02/male_04.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group02/male_05.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group02/male_06.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group02/male_07.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group02/male_08.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group02/male_09.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03/male_01.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03/male_02.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03/male_03.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03/male_04.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03/male_05.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03/male_06.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03/male_07.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03/male_08.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03/male_09.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03m/male_01.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03m/male_02.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03m/male_03.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03m/male_04.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03m/male_05.mdl");
rpc.animation.AddMaleHumanModel("models/humans/group03m/male_06.mdl");
...
PrintTable( rpc.animation.models.male )